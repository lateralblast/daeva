...
def get_filezilla_pkg_url(app_name,app_url)
  pkg_url = get_macupdate_url(app_name,app_url)
  return pkg_url
end

def get_filezilla_rem_ver(app_name,app_url)
...
def do_filezilla_post_install(app_name,app_url)
  return
end
